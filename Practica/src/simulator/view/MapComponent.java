...
public class MapComponent extends JPanel implements TrafficSimObserver {
    ...
    private void initGUI() {
        ...
        _car = ImagenesMapas.CAR_FRONT.imagen();
    }
    ...
    private void updatePrefferedSize() {
        ...
        maxW += 20;
        maxH += 20;
        //El if es para evitar evitar parpadeo en las ventanas
    ...
    //HE CAMBIADO TODO PREGUNTAR SI DEJARLO ASI O QUE HACER
    private Image loadImage(String img) {
        Image i = null;
        try {
            URL u = null;
            u = MapByRoadComponent.class.getResource("icons/"+img);
