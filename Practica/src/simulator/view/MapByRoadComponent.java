...
public class MapByRoadComponent extends JComponent implements TrafficSimObserver {
    ...
    private Image changeCO2(Road r){
        ...
        /*if(c == 0) return loadImage("cont_0.png");
        if(c == 1) return loadImage("cont_1.png");
        if(c == 2) return loadImage("cont_2.png");
        if(c == 3) return loadImage("cont_3.png");
        if(c == 4) return loadImage("cont_4.png");
